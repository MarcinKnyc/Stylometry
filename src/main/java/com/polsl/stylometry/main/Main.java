...
import com.polsl.stylometry.controller.Stylometry;
 ...
 * @author Marcin Knyć
 * @version 0.1
 * Pass the command line arguments in any order. Available commands are described in CommandLineArgumentsParser.
 */
public class Main {
